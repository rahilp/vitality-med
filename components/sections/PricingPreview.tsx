...
export function PricingPreview() {
  ...
  return (
    <Section background="white" spacing="lg">
      ...
      <div className="mb-8">
        <div className="bg-teal-primary/10 border-2 border-teal-primary/30 rounded-xl p-5 max-w-2xl mx-auto">
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-teal-primary flex items-center justify-center">
              <span className="text-white text-lg font-semibold">$</span>
            </div>
            <div>
              <h4 className="text-base font-semibold text-teal-primary mb-1">Use Your HSA or FSA</h4>
              <p className="text-sm text-gray-700">
                Members can use their Health Savings Account (HSA) or Flexible Spending Account (FSA) to pay for their monthly membership fees.
              </p>
            </div>
          </div>
        </div>
