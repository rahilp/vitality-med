    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl mb-4 text-[var(--color-teal-primary)]">Frequently Asked Questions</h2>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <span className="text-lg text-[var(--color-teal-primary)] pr-8">{faq.question}</span>
                <ChevronDown 
                  className={`w-6 h-6 text-[var(--color-gold-primary)] flex-shrink-0 transition-transform ${
