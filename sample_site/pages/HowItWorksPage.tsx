    ...
    <>
      <section className="bg-gradient-to-br from-[var(--color-teal-primary)] to-[var(--color-teal-dark)] text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl mb-6">
            Simple Steps to <span className="text-[var(--color-gold-primary)]">Better Healthcare</span>
          </h1>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl mb-8 text-[var(--color-teal-primary)] text-center">
            What Happens After You Join?
          </h2>
          
          <div className="space-y-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-xl mb-4 text-[var(--color-teal-primary)]">Welcome Call</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-xl mb-4 text-[var(--color-teal-primary)]">Comprehensive Health Assessment</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-xl mb-4 text-[var(--color-teal-primary)]">Personalized Care Plan</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              <h3 className="text-xl mb-4 text-[var(--color-teal-primary)]">Ongoing Support</h3>
              <p className="text-gray-700">
